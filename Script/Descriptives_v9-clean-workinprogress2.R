...
corplot_dt
ggsave(file.path(plot_d, "Corplot_cbrvstop5_drugtype.pdf"), plot=corplot_dt, width=1800, height=1300, units="px")
...
ggsave(file.path(plot_d, "corplot_by_yg_phase.pdf"), plot=corplot_ef_tox_yg_phase, width=1800, height=1300, units="px")
...
ggsave(file.path(plot_d, "preselection_by_yeargroup.pdf"), plot=targeted_yeargroup, width=1200, height=1200, units="px")
...
# Save the plot
ggsave(file.path(plot_d, "Investigational_Status_YearGroup.pdf"), plot = investigational_status_plot, width=1700, height=1200, units="px")
...
ggsave(file.path(plot_d, "ps2_by_yeargroup.pdf"), plot=ps_ratio_plot, width=1200, height=1200, units="px")
...
ggsave(file.path(plot_d, "ps2_by_yeargroup_no_unknown.pdf"), plot=ps_ratio_plot_filtered, width=1200, height=1200, units="px")
...
ggsave(file.path(plot_d, "median_age_by_yeargroup.pdf"), plot=med_age_plot, width=1200, height=1200, units="px")
...
ggsave(file.path(plot_d, "median_age_by_yeargroup_no_missing.pdf"), plot=med_age_plot_filtered, width=1200, height=1200, units="px")
...
ggsave(file.path(plot_d, "drugtype_by_yeargroup.pdf"), plot=drugtype_year_plot, width=1700, height=1200, units="px")
