...
db <- read_excel(file.path(output, "filtered_db_230508_v3.xlsx"))
...
rstudioapi::savePlotAsImage(file.path(plot, "ORR.png"), width = 800, height = 2500)
...
rstudioapi::savePlotAsImage(file.path(plot, "CBR_year.png"), width = 800, height = 2500)
...
rstudioapi::savePlotAsImage(file.path(plot, "CBR_subgroup.png"), width = 800, height = 3000)
...
rstudioapi::savePlotAsImage(file.path(plot, "CBR_subgroup_noNA.png"), width = 800, height = 2100)
...
rstudioapi::savePlotAsImage(file.path(plot, "ORR_subgroup.png"), width = 800, height = 3000)
...
rstudioapi::savePlotAsImage(file.path(plot, "DLT_subgroup.png"), width = 800, height = 2000)
...
rstudioapi::savePlotAsImage(file.path(plot, "disc_subgroup.png"), width = 800, height = 2000)
